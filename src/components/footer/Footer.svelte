<script lang="ts">
    ...
    import BWFlag from "$lib/assets/hackClubFlag.svg";
</script>

<footer class="w-full pt-20 pb-15 px-20 bg-[#121217]">
    <div
        class="flex flex-col md:flex-row w-full h-full items-start justify-center mx-auto mb-16 gap-x-16 gap-y-12"
    >
        <div class="flex flex-col gap-0 shrink-0">
            ...
            >
                <img src={BWFlag} class="w-50 mb-7" alt="" /></a
            >
            <p class="font-medium text-xl mb-2">For teens, by teens.</p>
            <p class="font-medium text-xl mb-8">
                <a href="tel:18556254225"> 1-855-625-HACK (call toll-free)</a>
            </p>
            <div class="flex flex-row gap-3">
                ...
                >
                    <svg
                        ...
                        height="48"
                        ><path
                            d="M20.0065 15.7665L13.5265 19.1265L13.522 12.384L20.0065 15.7665Z"
                        /><path
        ...
        <div class="flex flex-row gap-12 flex-wrap">
            <div>
                <p class="font-bold text-xl/[1.2] mb-4 lh">Hack Club</p>
                <ul
                    class="list-none list-image-none list-outside flex flex-col gap-3.5"
                >
                    <FooterLink
                        link="https://hackclub.com/philosophy"
                        title="Philosophy"
                    />

                    <FooterLink
                        link="https://hackclub.com/team"
                        title="Our Team & Board"
                    />
                    <FooterLink link="https://hackclub.com/team" title="Jobs" />
                    <FooterLink
                        link="https://hackclub.com/brand"
                        title="Branding"
                    />
                    <FooterLink
                        link="https://hackclub.com/press"
                        title="Press Inquiries"
                    />
                    <FooterLink
                        link="https://hackclub.com/philanthropy"
                        title="Donate"
                    />
                    <FooterLink
                        link="https://hackclub.com/imprint"
                        title="Imprint"
                    />
                </ul>
            </div>
            <div>
                <p class="font-bold text-xl/[1.2] mb-4 lh">Resources</p>
                <ul
                    class="list-none list-image-none list-outside flex flex-col gap-3.5"
                >
                    <FooterLink
                        link="https://hackclub.com/programs"
                        title="Programs"
                    />
                    <FooterLink
                        link="https://events.hackclub.com/"
                    ...
                    />
                    <FooterLink
                        link="https://toolbox.hackclub.com/"
                        title="Toolbox"
                    />
                    <FooterLink
                    ...
                    <FooterLink
                        ...
                        title="HCB Fiscal Sponsorship"
                    />
                    <FooterLink
                        link="https://hackclub.com/conduct"
                        title="Code of Conduct"
                    />
                    <FooterLink
                        link="https://hackclub.com/safeguarding"
                        title="Safeguarding Policy"
                    />
                    <FooterLink
                        link="https://hackclub.com/privacy-and-terms"
                        title="Privacy & Terms"
                    />
                </ul>
            </div>
